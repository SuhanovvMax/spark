...
with open('/opt/spark/credentials_example.json') as json_file:
...
spark_app_name = "shkCreate_edu_simple"
spark_ui_port = "8081"
...
sql_insert = f"""insert into {ch_db_name}.{ch_dst_table}
    ...
    left any join
    (
        select shk_id shk_id_new, wh_id wh_id_new
        from tmp.tmp_shkCreate_edu_100
    ) t2
    on t1.shk_id = t2.shk_id_new
"""
